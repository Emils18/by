...
const config = {
    serverInfo: {
        ...
        serverName: "Baybayin SMP", /*Server name*/
        serverIp: "20.205.21.110:7777", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "845337367870308373" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    adminTeamPage: {
        leaders: [
            {
                inGameName: "Bibs Creator",
                rank: "Owner",
                skinUrlOrPathToFile: "images/about-section-person-image.png",
                rankColor: " var(--main-color)"
            },
            
            {
                inGameName: "FarCreator100",
                rank: "Co-Owner",
                skinUrlOrPathToFile: "images/about-section-person-image.png",
                rankColor: " var(--main-color)"
            },
        ...
        developers: [
            ...
            },
            {
                inGameName: "Winkey0",
                rank: "Developer",
                skinUrlOrPathToFile: "images/mon.png",
                rankColor: ""
            },
        ],
        helpers: [
